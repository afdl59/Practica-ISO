...
import realMadridLogo from '../../assets/logoTeams/real_madrid_logo.png';
    ...
    <div className="partido-detalle">
      ...
      <div className="video-resumen">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/bxnNxYVi8yM?si=5nwbtFwtMpUxOf-q"  // Video resumen de la final
